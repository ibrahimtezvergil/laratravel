...
<!--                        &lt;!&ndash; property Sidebar &ndash;&gt;-->
<!--                        <div class="exlip-page-sidebar">-->

<!--                            &lt;!&ndash; Find New Property &ndash;&gt;-->
...
<!--                    </div>-->
                    ...
                    <div class="order-1 content-area col-lg-12 col-md-12 order-md-1 order-lg-2">
                        ...
                        <div class="row m-0">
                            ...
                            <!-- Single Tour Place -->
                            <div v-for="item in dataList" class="col-lg-4 col-md-4 col-sm-12">
...
<!--                                    <span class="onsale-section"><span class="onsale">Save 15%</span></span>-->
                                    <div class="tour-simple-thumb">
                                        <router-link :to="{name:'front-detail'}"><img  :src="'/upload/article/'+item.id+'/'+item.coverImg" class="img-fluid img-responsive" alt=""></router-link>
                                    </div>
                                    <div class="tour-simple-caption">
                                        <div class="ts-caption-left">
                                            ...
                                            <h4 class="ts-title"><router-link :to="{name:'front-detail'}">{{item.title}}</router-link></h4>
                                        </div>
...
export default {
    ...
    methods:{
        async getData(slug){
            await  axios.get("/api/web/blog/"+slug)
                .then(res => {
