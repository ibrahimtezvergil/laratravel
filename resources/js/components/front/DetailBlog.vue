<template>
    <div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="blog-details single-post-item format-standard">
                            <div class="post-details">
                                ...
                                <div class="post-featured-img">
                                    <img class="img-fluid" src="\front\assets\img\g-2.jpg" alt="">
                                </div>
                        ...
                        <div class="blog-details single-post-item format-standard">
                            ...
                            <div class="posts-author">
                                <span class="img"><img class="img-fluid" src="\front\assets\img\user-3.jpg" alt=""></span>
                                            ...
                                            <li class="single-comment">
                                                <article>
                                                    <div class="comment-author">
                                                        <img src="\front\assets\img\user-1.jpg" alt="">
                                                    </div>
                                                ...
                                                <ul class="children">
                                                    <li class="single-comment">
                                                        <article>
                                                            <div class="comment-author">
                                                                <img src="\front\assets\img\user-3.jpg" alt="">
                                                            </div>
                                                            <div class="comment-details">
                                                                <div class="comment-meta">
                                                                    <div class="comment-left-meta">
                                                        ...
                                                        <ul class="children">
                                                            <li class="single-comment">
                                                                <article>
                                                                    <div class="comment-author">
                                                                        <img src="\front\assets\img\user-4.jpg" alt="">
                                                                    </div>
                                                                    <div class="comment-details">
                                                                        <div class="comment-meta">
                                                                            <div class="comment-left-meta">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="single-widgets widget_thumb_post">
                            ...
                            <ul>
                                <li>
										<span class="left">
											<img src="\front\assets\img\g-1.jpg" alt="" class="">
										</span>
                                    <span class="right">
                                ...
                                <li>
										<span class="left">
											<img src="\front\assets\img\g-2.jpg" alt="" class="">
										</span>
                                    <span class="right">
                                ...
                                <li>
										<span class="left">
											<img src="\front\assets\img\g-3.jpg" alt="" class="">
										</span>
                                    <span class="right">
                                ...
                                <li>
										<span class="left">
											<img src="\front\assets\img\g-4.jpg" alt="" class="">
										</span>
                                    <span class="right">
                                ...
                                <li>
										<span class="left">
											<img src="\front\assets\img\g-5.jpg" alt="" class="">
										</span>
                                    <span class="right">
        ...
        <!-- ============================ Newsletter Start ================================== -->
        <section class="alert-wrap pt-5 pb-5" style="background:#ff5722 url(/front/assets/img/bg-new.png);">
            <div class="container">
                <div class="row">
